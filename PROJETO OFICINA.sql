...
MEUS CONHECIMENTOS EM SQL, COM O OBJETIVO DE ME TORNAR UMA DBA. ESTE É UM BANCO DE DADOS PARA AUTOMATIZAR O SERVIÇO DE UMA OFICINA,
...
/* THIS IS A PROJECT MADE BY ARIELI LEANDRO GUTIERRES, THE MAIN IDEA OF THIS DATABASE IS TO TRAIN AND IMPROVE
MY KNOWLEDGE IN SQL, WITH THE GOAL OF BECOMING A DBA. THIS IS A DATABASE FOR AUTOMATING THE SERVICE OF A WORKSHOP,
AUTOMATING THE ONBOARDING OF REGULAR CUSTOMERS AND NEW CUSTOMERS. THE MAIN TABLE IS THE CUSTOMER TABLE AND THE CAR TABLE,
MOST TABLES REFERENCE BOTH THE CUSTOMER TABLE AND THE CARS TABLE, USING THE PRIMARY KEY
IDCLIENTE AND IDCARRO AND FOREIGN KEYS ID_CLIENTE AND ID_CARRO, WITH THE ENTIRE DATABASE BEING A 1 X 1 RELATIONSHIP,
(IN THIS DATABASE THE CUSTOMER HAS ONLY ONE CAR, ONE PHONE, AND THE CAR HAS ONLY ONE COLOR AND ONE MECHANICAL SERVICE DONE).*/

/* AS FOR CUSTOMER INFORMATION, PHONE NUMBERS AND LICENSE PLATES, ALL INFORMATION CONTAINED IN THIS DATABASE
IT'S TOTALLY UNREAL, NOT REFERENCING ANY REAL PERSON. ALL NAMES IN THE CUSTOMER TABLE WERE CREATED FROM
FROM AN ARTIFICIAL INTELLIGENCE AND CHOSEN MANUALLY, THE CPF OF THE CUSTOMERS WERE ARITHMETIC PERMUTATIONS MADE FROM
OF COMBINATIONS OF DIGITS, ENSURING THAT NO NUMBER REFERS TO A REAL PERSON'S CPF, AS WELL AS THE INFORMATION
BY PHONE AND LICENSE PLATES.*/
...
/* CREATION OF THE TABLE OF THE CUSTOMERS' PHONE NUMBERS */
...
/* FIRST RECORDS IN THE CUSTOMER TABLE. ALL CUSTOMER NAMES AND SOCIAL SECURITY NUMBERS DO NOT REFER TO REAL PEOPLE
THE NAMES WERE RANDOMLY GENERATED BY AN ARTIFICIAL INTELLIGENCE AND THE CPF DIGITS WERE GENERATED THROUGH PERMUTATIONS 
ARITHMETIC ENSURING THEY DON'T REFERENCE A REAL PERSON */
...
/* QUERY OF SUMMARY INFORMATION OF CUSTOMERS, THEIR PHONES AND THEIR RESPECTIVE VEHICLES */
...
/* CREATION OF THE COLOR TABLE, REFERENCING THE CAR COLOR FROM THE CARS TABLE */
...
/* QUERY THAT RETURNS ONLY THE NAME OF THE CUSTOMERS AND THEIR CARS REFERRING TO THE MECHANICAL SERVICE DONE */
...
/* ENTERING THE REST OF THE DATA ABOUT THE CUSTOMERS, ALL THE CUSTOMER NAMES AND SOCIAL SECURITY NUMBERS DO NOT REFER TO REAL PEOPLE
THE NAMES WERE RANDOMLY GENERATED BY AN ARTIFICIAL INTELLIGENCE AND THE CPF DIGITS WERE GENERATED THROUGH PERMUTATIONS 
ARITHMETIC ENSURING THEY DON'T REFERENCE A REAL PERSON */
...
/* ENTERING ALL THE DATA PERTAINING TO ALL CUSTOMER'S CARS */
...
/* STARTING TO ENTER THE FIRST SERVICE TABLE DATA */
...
/* ENTERING THE DATA REGARDING THE COLOR AND TEXTURE OF THE CARS, REFERENCING THE CAR ID */
...
/* ENTERING THE MISSING DATA IN THE TABLE OF SERVICES DONE ON THE CARS, REFERRING TO THE CAR ID */
...
/* ENTERING ALL DATA FROM THE PHONE TABLE */
...
/* QUERY THAT JOINS ALL THE TABLES IN DATABASE */
...
/* QUERY THAT JOINS ALL THE TABLES OF FEMALE CUSTOMER INFORMATION */
...
/* QUERY THAT JOINS ALL THE TABLES OF INFORMATION OF MALE CUSTOMERS */
